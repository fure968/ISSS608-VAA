...
Importing the data set In the code chunk below, read_csv() of readr is used to import realis2018.csv into R and parsed it into tibble R data.frame format.

```{r}
realis2018 <- read_csv("data/realis2018.csv")
```

### 9.5.1.1 Data Wrangling and Manipulation
...
## 9.5.2 Grouped summaries without the Pipe
...
## 9.5.3 Grouped summaries with the pipe
...
## 9.5.4 Designing Treemap with treemap Package

treemap package is a R package specially designed to offer great flexibility in drawing treemaps. The core function, namely: treemap() offers at least 43 arguments. In this section, we will only explore the major arguments for designing elegent and yet truthful treemaps.

## 9.5.5 Designing a static treemap
...
## 9.5.6 Using the basic arguments
...
## 9.5.7 Working with vColor and type arguments
...
## 9.5.10 The “manual” type treemap
...
## 9.5.14 Designing Treemap using treemapify Package
...
## 9.5.15 Designing a basic treemap
...
## 9.5.17 Designing Interactive Treemap using d3treeR

Installing d3treeR package This slide shows you how to install a R package which is not available in cran.
...
## 9.5.18 Designing An Interactive Treemap
