...
### 2.1.4 Changing the active object
...
### 4.1.3 Working with facet_nodes()
...
### 6.1.1 Plotting the first interactive network graph
...
### 6.1.3 Working with visual attributes - Nodes
