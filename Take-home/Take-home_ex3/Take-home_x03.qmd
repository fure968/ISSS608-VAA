...
-   The visual analytics approach helps to highlight temporal patterns and changes in the companies however continuous monitoring and in-depth investigations will be needed uncover the underlying motivations.

```{=html}
<!-- -->
```
-   It is challenging to transform complex data into meaningful visualisations and each graph felt like peeing back layers to reveal the intricate web of corporate activities, almost like solving a puzzle with technical skills and creative thinking combined but it provides valuable insights to understand the network.
