...
::: {style="background-color: #FFF8DC; padding: 10px; border-radius: 5px; border: 1px solid #EEE; margin-bottom: 10px;"}
📈 <strong>Insight:</strong> </br> 
The Central Region has a wide distribution, indicating a large variation in unit prices within that region.</br>
The Central Region shows unit prices extending to the highest value on the graph, above $6000 PSF, suggesting it includes the most expensive properties compared to the other regions.</br>   
