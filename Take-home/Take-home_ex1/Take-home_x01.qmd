...
colSums(is.na(ds1))
ds1 <- na.omit(ds1)
ds1$`Sale Date` <- as.Date(ds1$`Sale Date`, format = "%d-%b-%y")
ds1$`Completion Date` <- as.Date(ds1$`Completion Date`, format = "%d-%b-%y")
...
colSums(is.na(ds2))
ds2 <- na.omit(ds2)
ds2$`Sale Date` <- as.Date(ds2$`Sale Date`, format = "%d-%b-%y")
ds2$`Completion Date` <- as.Date(ds2$`Completion Date`, format = "%d-%b-%y")
...
colSums(is.na(ds3))
ds3 <- na.omit(ds3)
ds3$`Sale Date` <- as.Date(ds3$`Sale Date`, format = "%d-%b-%y")
ds3$`Completion Date` <- as.Date(ds3$`Completion Date`, format = "%d-%b-%y")
...
colSums(is.na(ds4))
ds4 <- na.omit(ds4)
ds4$`Sale Date` <- as.Date(ds4$`Sale Date`, format = "%d-%b-%y")
ds4$`Completion Date` <- as.Date(ds4$`Completion Date`, format = "%d-%b-%y")
...
colSums(is.na(ds5))
ds5 <- na.omit(ds5)
ds5$`Sale Date` <- as.Date(ds5$`Sale Date`, format = "%d-%b-%y")
ds5$`Completion Date` <- as.Date(ds5$`Completion Date`, format = "%d-%b-%y")
